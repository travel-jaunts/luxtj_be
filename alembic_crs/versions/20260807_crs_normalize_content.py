...
def upgrade() -> None:
    ...
    op.add_column("hotel_crs_hotels", sa.Column("floors_count", sa.SmallInteger(), nullable=True))
    op.add_column("hotel_crs_hotels", sa.Column("rooms_count", sa.Integer(), nullable=True))
    op.add_column("hotel_crs_hotels", sa.Column("year_built", sa.SmallInteger(), nullable=True))
    op.add_column("hotel_crs_hotels", sa.Column("year_renovated", sa.SmallInteger(), nullable=True))
    op.add_column(
        "hotel_crs_hotels",
    ...
    op.drop_column("hotel_crs_hotels", "meta")
    ...
    op.add_column("hotel_crs_room_groups", sa.Column("is_family", sa.Boolean(), nullable=True))
    op.add_column("hotel_crs_room_groups", sa.Column("is_club", sa.Boolean(), nullable=True))
    op.add_column(
        "hotel_crs_room_groups",
    ...
    op.drop_column("hotel_crs_room_groups", "rg_ext")
    op.drop_column("hotel_crs_room_groups", "raw")
...
def downgrade() -> None:
    ...
    op.drop_table("hotel_crs_hotel_register_room_categories")
    op.drop_table("hotel_crs_hotel_policy_item_attrs")
    op.drop_table("hotel_crs_hotel_policy_items")
    op.drop_table("hotel_crs_hotel_policy_sections")
    op.drop_table("hotel_crs_hotel_feature_tags")
    op.drop_table("hotel_crs_hotel_payment_methods")
    op.drop_table("hotel_crs_hotel_description_sections")
    ...
    op.drop_column("hotel_crs_room_groups", "quality_label")
    op.drop_column("hotel_crs_room_groups", "class_label")
    op.drop_column("hotel_crs_room_groups", "view_type")
    op.drop_column("hotel_crs_room_groups", "floor_type")
    op.drop_column("hotel_crs_room_groups", "is_club")
    op.drop_column("hotel_crs_room_groups", "is_family")
    op.drop_column("hotel_crs_room_groups", "gender")
    ...
    for col in (
        ...
        op.drop_column("hotel_crs_hotels", col)
