# TODO: Update docstrings and comments in this file
# ref: https://github.com/open-telemetry/opentelemetry-python-contrib/blob/main/instrumentation/opentelemetry-instrumentation-requests/src/opentelemetry/instrumentation/requests/__init__.py
...
def _instrument(
    ...
    :code:`niquests.session.Session.request` (this includes
    :code:`niquests.get`, etc.)."""
    ...
    def instrumented_send(self: Session, request: PreparedRequest, **kwargs: Any):
        ...
        def get_or_create_headers():
            request.headers = (
                request.headers if request.headers is not None else CaseInsensitiveDict()
            )
        ...
        with (
            ...
            if isinstance(result, Response):
                ...
                if result.raw is not None:
                    ...
                    if version:
                        # HTTP/1 and above is supported by niquests
                        # TODO: update when niquests supports HTTP/2 or above
